<?php $pageTitle = '404 - Page Not Found'; include 'inc/header.php'; ?>
<!-- /Header -->
        <!-- Page Title -->
        <section class="tf-page-heading type-404 flat-spacing-5">
            <div class="container">
                <div class="content">
                    ...
                    <a href="index.php" class="tf-btn type-2">
                        back to home page
                    </a>
                </div>
            </div>
        ...
        <div class="flat-spacing">
            <div class="container">
                <div class="sect-heading space-1">
                    ...
                    <a href="shop-default.php" class="tf-btn-line fw-normal">
                        VIEW ALL
                    </a>
                </div>
                <div dir="ltr" class="swiper tf-swiper" data-preview="4" data-tablet="3" data-mobile-sm="2"
                    data-mobile="2" data-space="16" data-pagination="2" data-pagination-sm="2" data-pagination-md="3"
