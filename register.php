<?php $pageTitle = 'Register'; include 'inc/header.php'; ?>
<!-- /Header -->
        <!-- Log -->
                    ...
                    <form action="https://tfrosaline.vercel.app/account-page.html" class="form-log">
                        <div class="form-content">
                            <fieldset class="tf-field">
                                ...
                                <input class="style-3" type="text" id="registerFirstname" placeholder="Your first name"
                                    required>
                            </fieldset>
                            <fieldset class="tf-field">
                                <label class="text-body-xs" for="registerLastname">Last name*</label>
                                <input class="style-3" type="text" id="registerLastname" placeholder="Your last name"
                                    required>
                            </fieldset>
                            <fieldset class="tf-field">
                                <label class="text-body-xs" for="registerEmail">Your email*</label>
                                <input class="style-3" type="email" id="registerEmail" placeholder="Enter your email"
                                    required>
                            </fieldset>
                            <fieldset class="tf-field">
                        ...
                        <div class="tf-grid-layout mb-24">
                            <div class="checkbox-wrap">
                                ...
                                <label for="registerTerm" class="text-body-s text-start">
                                    ...
                                    <a href="404-2.php" class="link-underline">Terms of use</a>
                                    and
                                    <a href="404-3.php" class="link-underline">Privacy policy.</a>
                                </label>
                            </div>
                            <div class="checkbox-wrap">
                                <input type="checkbox" id="registerSub" class="tf-check" required>
                        ...
                        <div class="form-btn">
                            ...
                            <a href="login.php" class="tf-btn-line">
